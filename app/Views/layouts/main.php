...
<div class="app-shell">
  ...
  <div class="main-area">
    <header class="topbar">
      <button class="icon-button" data-sidebar-toggle aria-label="Toggle navigation"><span data-sidebar-icon class="icon-hamburger">&#9776;</span><span data-sidebar-icon class="icon-close">&#10005;</span></button>
