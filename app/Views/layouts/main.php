...
<div class="app-shell">
  ...
  <div class="main-area">
    <header class="topbar">
      <button class="icon-button" data-sidebar-toggle aria-label="Toggle navigation"><span class="icon-hamburger">&#9776;</span><span class="icon-close" style="display:none">&#10005;</span></button>
